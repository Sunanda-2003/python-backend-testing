...
redis_client = redis.Redis(
    host='nareshit-ry6sbc.serverless.use1.cache.amazonaws.com',
    port=6379,
    ssl=True,
...
db_write_config = {
    'host': 'database-1.c0rc80iig5vm.us-east-1.rds.amazonaws.com',
    'user': 'admin',
    'password': 'cloud123',
    'database': 'dev'
}
...
db_read_config = {
    'host': 'reader.c0rc80iig5vm.us-east-1.rds.amazonaws.com',
    'user': 'admin',
    'password': 'cloud123',
    'database': 'dev'
}
